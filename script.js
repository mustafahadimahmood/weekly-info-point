...
function renderTable() {
  ...
  for (let i = 0; i < 52; i++) { // 52 Wochen
    ...
    participants.forEach(p => {
      ...
      // Nur eigene Spalte bearbeiten, Admin darf alles
      ...
      // Vorherige Werte aus Firebase laden
    ...
    date.setDate(date.getDate() + 7); // nächste Woche
  }
}

// Speichern aller Änderungen in Firebase
function saveAll() {
